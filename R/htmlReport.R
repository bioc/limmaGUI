GetComponentsToExportInHTMLreport <- function(parameterizationIndex=NULL)
{
  ...
  Try(lbl2 <- tklabel(ttHTMLreportDialog,text="Components to be Included in the HTML Report",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="RNA Targets",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Spot Types",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Layout",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Spot Quality Weighting",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Color-Coded Raw M A Plots",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Print-Tip Group Loess Raw M A Plots",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Within-Array Normalized M Box Plots",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Spot Types Included In Linear Model",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Normalization Used In Linear Model",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Design Matrix (Parameterization)",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Duplicate Correlation",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Top 50 DE Genes",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="Complete Lists of DE-Ranked Genes",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="M A Plots (with fitted M values)",font=limmaGUIfont2))
  ...
  Try(currentLabel <- tklabel(ttHTMLreportDialog,text="t Statistic Box Plots",font=limmaGUIfont2))
...
# Need to test whether arrays have been loaded and whether a linear model has been fit.
  ...
  OK.but <-tkbutton(ttHTMLreportDialog,text="   OK   ",command=onOK,font=limmaGUIfont2)
  Cancel.but <-tkbutton(ttHTMLreportDialog,text=" Cancel ",command=onCancel,font=limmaGUIfont2)
